...
st.markdown("""
### 📖 사용 방법
1. **입력 폴더 경로**: 처리할 이미지가 들어있는 폴더 경로를 입력하세요.
2. **출력 폴더 경로**: 분류된 이미지를 저장할 폴더 경로를 입력하세요.
...
- **abnormal_groups_log**: 개수가 2개가 아닌 그룹들의 정보를 포함합니다.
- **processing_log**: 각 파일이 어떻게 처리되었는지 상세 내역을 포함합니다.
""")
